...
<br/><div class="container-fluid" style= "margin:0; background-image:url('resources/images/s1.jpg')">
<div class="row">
...
<form:form class="form-container" modelAttribute="product" method="post" action="${e}saveProduct" enctype="multipart/form-data">
 <h1><center><b>Add Product</b></center></h1>
...
<form:input required="" class="form-control" path="image" type="file"/></div>
 <div class="form-group">
